...
def inference(a):
    ...
    for source_path in tqdm.tqdm(wavs_test, desc="synthesizing each utterance"):
        ...
        with torch.no_grad():
            ...
            output_file = os.path.join('periodwave_encodec_base_turbo_step2_400k_rfwave_vocal'+'_'+str(a.solver)+'_'+str(a.bw)+'_'+str(a.iter)+'_'+str(a.noise_scale)+'_'+str(a.s_w)+'_'+str(a.b_w)+'_sway_'+str(a.sway), file_name)
    ...
    with open(os.path.join('periodwave_encodec_base_turbo_step2_400k_rfwave_vocal'+'_'+str(a.solver)+'_'+str(a.bw)+'_'+str(a.iter)+'_'+str(a.noise_scale)+'_'+str(a.s_w)+'_'+str(a.b_w)+'_sway_'+str(a.sway), 'score_list.txt'), 'w') as f:
        f.write('periodwave_encodec_base_turbo_step2_400k_rfwave_vocal Solver:{}\nIter: {}\nNoise_scale: {}\n'.format(a.solver, a.iter, a.noise_scale))
        f.write('bw: {}\n'.format(a.bw))
        f.write('s_w: {}\nb_w: {}\n'.format(a.s_w, a.b_w))
        f.write('Sway: {}\n'.format(a.sway))
