...
from periodwave.periodwave_encodec_utils import (
...
class VectorFieldEstimator(BaseModule):
    def __init__(
        self, n_mel=512, periods=[1, 2, 3, 5, 7], final_dim=32, hidden_dim=512
    ):
...
class FlowMatch(BaseModule):
    ...
    def compute_loss(self, x1, emb, length, tuning_steps, temperature):
        ...
        pred_x1 = self.forward(
            x1, emb, n_timesteps=tuning_steps, temperature=temperature
        )
