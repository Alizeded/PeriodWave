...
class GeneratorP(torch.nn.Module):
    def __init__(self, period, kernel_size=9, stride=4, use_spectral_norm=False, final_dim=32, hidden_dim=512):
...
class MultiPeriodGenerator(torch.nn.Module):
    def __init__(self, use_spectral_norm=False, periods=[1,2,3,5,7], final_dim=32, hidden_dim=512):
