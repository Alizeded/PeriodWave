...
from model.periodwave_large_utils import MultiPeriodGenerator, MelSpectrogramUpsampler, FinalBlock

LRELU_SLOPE = 0.1
from math import sqrt

class GradLogPEstimator(BaseModule):
    def __init__(self, n_mel, periods, final_dim=48, hidden_dim=768):
