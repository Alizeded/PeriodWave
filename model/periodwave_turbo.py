...
class FlowMatch(BaseModule):
    def __init__(self, n_mel=100, periods=[1,2,3,5,7], noise_scale=0.25, final_dim=32, hidden_dim=512, sampling_rate=24000):
        super().__init__() 
        self.sigma_min = 1e-4 
    ...
    def compute_loss(self, x1, mel, target_std, length, tuning_steps, temperature): 
        ...
        pred_x1 = self.forward(x1, mel, target_std, n_timesteps=tuning_steps, temperature=temperature)
